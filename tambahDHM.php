...
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
	$sql="select * from dhakmilik where nh like'%$cari%' or
						  kel like '%$cari%' or
						  kec like '%$cari%'";
}else{
	$sql="select * from dhakmilik";		
}
...
if (isset($_POST['cari'])){
	...
	$sql="select * from dhakmilik limit $awalData,$jmlDataPerHal";		
}
...
<!--BEDA SECTION-->
	...
	<div class="container1">
        ...
        <p>
		<form method="post" action="simpanDTHM.php" enctype="multipart/form-data">
