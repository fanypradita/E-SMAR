...
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
	$sql="select * from hakpakai where nh like'%$cari%' or
						  kel like '%$cari%' or
						  kec like '%$cari%'";
}else{
	$sql="select * from hakpakai";		
}
...
if (isset($_POST['cari'])){
	...
	$sql="select * from hakpakai limit $awalData,$jmlDataPerHal";		
}
...
<!--BEDA SECTION-->
	...
	$id=$_GET['kode'];
	$sql="select * from hakpakai where id='$id'";
	...
	<div class="container1">
		...
		<div class="row">	
		<div class="col-sm-9">
			<form enctype="multipart/form-data" method="post" action="simpanEHP.php">
