        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <ul class="dropdown-content" aria-labelledby="navbarDarkDropdownMenuLink">
                    <li><a class="nav-link" href="PHM.php">Hak Milik</a></li>
                    <li><a class="nav-link" href="PHGU.php">Hak Guna Usaha</a></li>
                    <li><a class="nav-link" href="PHP.php">Hak Pakai</a></li>
                    <li><a class="nav-link" href="PHW.php">Hak Wakaf</a></li>
                    <li><a class="nav-link" href="PHL.php">Hak Pengelolaan</a></li>
                    <li><a class="nav-link" href="PHT.php">Hak Tanggungan</a></li>
                </ul>
                </li>
            </ul>
                <li class="nav-item">
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
				<a class="btn btn-outline-primary btn-sm" href="detailPHM.php?kode=<?php echo $row['id']?>">Detail</a>
			</tr>
			<?php 
			$no++;
		}
