...
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
	$sql="select * from dhaktanggung where nh like'%$cari%' or
						  kel like '%$cari%' or
						  kec like '%$cari%'";
}else{
...
<!--BEDA SECTION-->
	...
	<div class="container1">
        ...
        <p>
		<form method="post" action="simpanDTHT.php" enctype="multipart/form-data">
        <div class="form-group">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="no_hak" id="no_hak" >
			</div>
            <div class="form-group">
				<label for="thn">Tahun:</label>
				<input class="form-control" type="text" name="thn" id="thn">
			</div>
			<div class="form-group">
